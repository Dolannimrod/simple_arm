...
def generate_launch_description():
    ...
    pkg_pick_place_arms = FindPackageShare('pick_place_arms')
    default_rviz_config_path = PathJoinSubstitution([pkg_pick_place_arms, 'rviz', 'urdf.rviz'])
